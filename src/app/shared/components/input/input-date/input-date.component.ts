import { Component, computed, forwardRef, inject, Injector, input, InputSignal, model, ModelSignal, OnInit, Signal, WritableSignal, signal } from '@angular/core';
...
export class InputDateComponent implements OnInit, ControlValueAccessor {
  ...
  input<string>(`date-${crypto.randomUUID()}`);
